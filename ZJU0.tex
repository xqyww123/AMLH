...
\begin{document}
  ...
  \title[]{一种类型系统的扩广与基于其的形式化方法}
	% 如果标题一行写不下，就写成两行，在下面的命令里写第二行，不需要两行则注释掉
    %\titletl{第二行}
	
	%英文题目
	\Etitle{An extension of type system and a new formal method based on it}
  ...
  \appendix
  \input{./chapters/how-to-deduct-theorem-to-construct-program.tex}
