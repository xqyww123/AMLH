...
于是表示这一个元素不需要使用任何实质的现象除了独特的零现象$\mathrm{p}_0$，
不占用任何二进制位，而在最后编译出的
...
至今尚未明确地具体定义现象，而是留作为可定制的框架，令 $\rho(i)$ 表示用以表示数字i
...
仅仅将现象 Noesis 对应到现象过程，本体只是现象过程，而很多时候期望对函数参数的本体约束更多，
诸如这种现象过程具在某些特定理解下 Noesis 对应到一个本质上的函数。
