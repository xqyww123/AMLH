...
\[ \begin{split} \forall f_e\ i\ \cdots\ k\ l\ cond.\ 
 \mathbf{V}_l\ \land\ &(\forall a_e\ \cdots\ c_e.\ cond\ a_e\ \cdots\ c_e \Rightarrow
...
\UnaryInfC{$\mathbf{V}_l,\ (\forall a_e\ \cdots\ c_e.\ cond\ x_e \Rightarrow x_e
\in \mathbf{Se}_l) \vdash \exists f_p.\ f_p \proctr{i|\cdots|k|l}{cond} f_e$}
...
{\center \begin{prooftree}
    ...
    \RightLabel{基元虚构律}
    \BinaryInfC{$\vdash f_p \proctr{i|\cdots|k|l}{cond} f_e$}
\end{prooftree}}
