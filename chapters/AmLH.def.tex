...
\begin{defin}[超越对应关系] 定义三元关系 $ p \widesim{i} e$ 表示现象与本质在某种理解
    下的的对应关系。
\begin{equation}
     p \widesim{i} e \coloneqq p \in \mathbf{Sp}_i \land (\mathbf{Tr}_i\ p = e)
\end{equation}
\end{defin}
...
\begin{align*}
  \forall p\ i\ e.\ \mathbf{V}_i \Rightarrow p \widesim{i} e \Rightarrow
    e \in \mathbf{Se}_i
\end{align*}
\end{theo}
...
\begin{example}[以虚构方式引入列表理解] 现在假设 $\abs{\mathrm{phenomenon}} = \aleph_1$，
