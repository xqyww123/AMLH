...
%
%
%程序具有的性质也是其抽象意义具有的性质，于是可以证明抽象意义的性质以
%证明程序的性质。
%再而本文围绕 Noesis 定理提出了 Noesis 形式系统，允许演绎而构建
%Noesis 定理，进而构建程序，并得到此程序的抽象意义，且此程序的抽象意义与
%程序的关联被定理保障。
%
%证明程序的抽象意义的性质
%
...
描述程序与其抽象意义（Abstract Meanning）的关联。
一个程序的抽象意义，是一个数学对象，其具有程序所拥有的，一切形式化描述
（Formal Specification）所关切的性质的数学对象，
进而可以证明抽象意义的性质来证明程序的性质。

指令集与常量集的抽象意义构成 Noesis 系统的公理，
定义了此指令或常量所有的性质。
Noesis 系统的演绎律决定常量与指令如何组合成程序，以及相应的组合程序
的抽象语义如何由指令与常量的抽象语义推导。
...
单独的指称并没有任何意义，理解可以任意地构造以将任何现象对应到
任何本体。
...
%现在放下理念的美好回到现实，
接下来讨论具体如何在实际的工业生产中演绎 Noesis 理论以
