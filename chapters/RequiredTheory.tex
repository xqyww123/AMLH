\chapter{相关理论基础及工具简介} \label{Ch.ReqTh}

\input{./chapters/Attention.tex}
\input{./chapters/RequiredTheory/contract-tools.tex}
...
其中 HOL 系列起源于 1972年 Robin Milner 的 LCF 程序\cite{lcf_hol_history}，
...
那么此定理证明器满足 de Burijn 标准 \cite{barendregt2002autarkic}。

HOL系列以及其中的 HOL4 是满足 de Burijn 标准的。
...
\begin{defin}[用于定义HOL逻辑上值与函数的记号] 然后是定义值与函数的记号
    ...
    \end{split}   \]
其中 $x_1\cdots x_n$ 为参数符号。可以显式地指定参数类型：
    \[ 
