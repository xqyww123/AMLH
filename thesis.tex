...
\begin{document}
  ...
  %\titletl{与基于其的形式化方法}
	...
	%英文题目
	\Etitle{Simplify formal verfication via abstract semantic}
	% 如果一行写不下，同中文题目设定，一行写不下则写两行，不需要就注释掉
	%\Etitletl{and a new formal method based on it}
	...
	% 研究方向
	\researchdm{逻辑与验证} \Eresearchdm{Logic and verfication}
